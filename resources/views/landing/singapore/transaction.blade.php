        ...
        <div class="container">
            ...
            <div class="row gx-4">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('singapore.transaction.store') }}" method="post">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="customer_name" class="form-control" id="exampleFormControlInput1" required />
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control price" name="price" aria-label="Username" aria-describedby="basic-addon1" readonly value="{{ $product->price }}">
                                </div>
                                <!--<div class="mb-3">-->
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="qty" class="form-control qty" id="exampleFormControlInput1" placeholder="0" required />
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">$</span>
