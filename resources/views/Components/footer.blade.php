<div class="container-fluid bg-dark footer mt-5 mb-0 py-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p>Dapatkan info bermanfaat dari kami.</p>
...
<!-- Copyright Start -->
<div class="container-fluid bg-secondary mb-0 text-body copyright py-4">
    <div class="container">
        <div class="row">
